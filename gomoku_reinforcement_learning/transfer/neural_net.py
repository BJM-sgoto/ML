...
import numpy as np
from constants import RANDOM_SEED, P_E, BOARD_WIDTH, BOARD_HEIGHT
...
class PolicyValueNet:	
	...
	def policy_value_op(self, input_state):
		...
		#n_layer = max(BOARD_HEIGHT, BOARD_WIDTH)-1
		n_layer = 2
	...
	# mcts_probs: target probability
	# winner_batch: target value
